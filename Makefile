...
$(TARGET): main.c v4l2.lo display-kms.lo util.lo vpe-common.lo input_cmd.lo drawing.lo exam_cv.lo car_lib.lo project.lo 
	$(CC) $(CFLAGS) -o $@ main.c v4l2.lo display-kms.lo util.lo vpe-common.lo input_cmd.lo drawing.lo exam_cv.lo car_lib.lo project.lo $(LDFLAGS)

project.lo: project.c project.h
	$(CC) -c $(CFLAGS) -o $@ project.c
